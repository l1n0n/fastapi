...
def hello():
    return HTMLResponse(content='''<img src="https://images.meme-arsenal.com/8e2a489b9edf3b50b3e2f195f3693d0b.jpg" alt="Игорь смотри че могу" width="5000" height="800">''')
...
def add_student(new_student: Student, db: Session = Depends(get_db)):
    new_id = max((s.id for s in db.query(StudentDataBase).all()), default=0) + 1
